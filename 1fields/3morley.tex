...
\begin{lem}[Smallest rank representative of a type]
...
\begin{proof}
    ...
    Since \linkto{OHMYGODWHATTHEFUCK}{independent sets of the same length %?
    have the same type}, for each $i \in \N$ 
    ...
    pregeometry.
    Then as \linkto{OHMYGODWHATTHEFUCK}{independent sets of the same length %?
        have the same type} we have $\tp(a) = \tp(c)$,
