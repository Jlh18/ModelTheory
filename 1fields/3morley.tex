...
\begin{proof}
    ...
    %? Marker introduces om-saturated structure here. Why?
...
\begin{proof}
    ...
    Let $\M$ be a 
    \linkto{existence_of_monster}{$\ka$-saturated elementary extension} of $K$
    ...
    \[
        K(a_1,\dots,a_n) \iso %? what result are we using here?
    ...
    Now \linkto{ACF_strong_min}{$\ACF$ is strongly minimal}
    and $\dim_{\Si_\RNG(K),\M}(\M)$ is infinite %? Why?
