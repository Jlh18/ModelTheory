...
\begin{proof}
    ...
    \begin{backward}
        ...
        Then \linkto{not_a_consequence}{
            there exists a non-empty model}
...
It is motivated by the \linkto{infite_infinite_classes}{example at the end}, 
...
\begin{lem}[Equivalent definition of completeness]
...
\begin{proof}
    ...
    \begin{backward}
        ...
        Then \linkto{not_a_consequence}{there exist 
            non-empty models of $T$} 
        such that $\MM \nodel{\Si} \phi$ and $\NN \nodel{\Si} \NOT \phi$.
