...
\input{0pure_model_theory/1signature.tex}
\input{0pure_model_theory/2compactness.tex}
\input{0pure_model_theory/3lemmas.tex}
\input{0pure_model_theory/4types.tex}
\input{0pure_model_theory/7quantifier.tex}
\input{0pure_model_theory/8morley_rank.tex}

\chapter{Appendix}
\input{10appendix/-1directlimit.tex}
\input{10appendix/5.0boolean.tex}
\input{10appendix/5.1ultraprod.tex}
\input{10appendix/5.2stone_filters.tex}
\input{10appendix/6ordinal.tex}
\input{10appendix/8pregeom.tex}

\chapter{Model Theory of Fields}
\input{1fields/1ax_groth.tex}
\input{1fields/2quantifier.tex}
\input{1fields/3morley.tex}
\chapter{Appendix}
\input{10appendix/0algebraic_closure.tex}
\input{10appendix/1transcendence.tex}
\input{10appendix/2loc_fin_poly_maps.tex}
\input{10appendix/3noetherian.tex}
\input{10appendix/4zariski.tex}
\input{10appendix/7krull.tex}
